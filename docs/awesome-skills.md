...
| <a id="standalone-and-local-graft"></a>[graft](#standalone-and-local-graft) | Use the installed Graft CLI or MCP tools for local code search, repository maps, file APIs, and call tracing when exploring or changing a… | Local definition; public source not recorded |
